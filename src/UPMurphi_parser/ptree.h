...
public:
	...
	static string print_licence() {
		string toReturn;
		toReturn = "\n\nUPMurphi PDDL+ Compiler Release 1.0R5\n ";
		toReturn
...
public:
    ...
    string upmurphi_keyword_removal(const string& original_name){
        // list of reserved UPMurphi words that cannot be used as symbol name
        /*    
        ...
        replaceAll(name,"-","_");
        replaceAll(name,"alias","alias_");
        replaceAll(name,"array","array_");
        replaceAll(name,"boolean","boolean_");
        replaceAll(name,"const","const_");
        replaceAll(name,"end","end_");
        replaceAll(name,"endforall","endforall_");
        replaceAll(name,"endrecord","endrecord_");
        replaceAll(name,"endswitch","endswitch_");
        replaceAll(name,"exists","exists_");
        replaceAll(name,"function","function_");
        replaceAll(name,"invariant","invariant_");
        replaceAll(name,"program","program_");
        replaceAll(name,"rule","rule_");
        replaceAll(name,"then","then_");
        replaceAll(name,"type","type_");
        replaceAll(name,"assert","assert_");
        replaceAll(name,"by","by_");
        replaceAll(name,"do","do_");
        replaceAll(name,"endalias","endalias_");
        replaceAll(name,"endfunction","endfunction_");
        replaceAll(name,"endrule","endrule_");
        replaceAll(name,"endwhile","endwhile_");
        replaceAll(name,"FALSE","FALSE_");
        replaceAll(name,"if","if_");
        replaceAll(name,"of","of_");
        replaceAll(name,"put","put_");
        replaceAll(name,"ruleset","ruleset_");
        replaceAll(name,"to","to_");
        replaceAll(name,"var","var_");
        replaceAll(name,"begin","begin_");
        replaceAll(name,"case","case_");
        replaceAll(name,"else","else_");
        replaceAll(name,"endexists","endexists_");
        replaceAll(name,"endif","endif_");
        replaceAll(name,"endruleset","endruleset_");
        replaceAll(name,"enum","enum_");
        replaceAll(name,"for","for_");
        replaceAll(name,"in","in_");
        replaceAll(name,"procedure","procedure_");
        replaceAll(name,"record","record_");
        replaceAll(name,"startstate","startstate_");
        replaceAll(name,"traceuntil","traceuntil_");
        replaceAll(name,"while","while_");
        replaceAll(name,"clear","clear_");
        replaceAll(name,"elsif","elsif_");
        replaceAll(name,"endfor","endfor_");
        replaceAll(name,"endprocedure","endprocedure_");
        replaceAll(name,"endstartstate","endstartstate_");
        replaceAll(name,"error","error_");
        replaceAll(name,"forall","forall_");
        replaceAll(name,"interleaved","interleaved_");
        replaceAll(name,"process","process_");
        replaceAll(name,"return","return_");
        replaceAll(name,"switch","switch_");
        replaceAll(name,"TRUE","TRUE_");
        replaceAll(name,"pddlname","pddlname_");
        replaceAll(name,"durative_end","durative_end_");
        replaceAll(name,"clock","clock_");
        replaceAll(name,"action","action_");
        replaceAll(name,"weight","weight_");
        replaceAll(name,"duration","duration_");
